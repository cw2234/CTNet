...
class EEGNet(nn.Module):
    def __init__(
        ...
        self.depthwise_conv = nn.Conv2d(
            f1, f1 * D, (number_channel, 1), (1, 1), groups=f1, bias=False
        )
        ...
        self.separable_conv = nn.Conv2d(
            f1 * D, f2, (1, 16), padding="same", groups=f1 * D, bias=False
        )
        ...
        self.classifier = nn.Linear(
            f2 * (signal_length // pooling_size1 // pooling_size2), nb_classes
        )
