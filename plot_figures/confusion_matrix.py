...
plt.xticks(
    tick_marks, ["Left", "Right", "Foot", "Tongue"], fontsize=15
)  # , rotation=45
...
for i in range(len(["Left", "Right", "Foot", "Tongue"])):
    for j in range(len(["Left", "Right", "Foot", "Tongue"])):
        plt.text(
            j,
            i,
            "{:.2%}".format(cm_4_percentage[i, j]),
            ha="center",
            va="center",
            color="white"
            if cm_4_percentage[i, j] > cm_4_percentage.max() / 2.0
            else "black",
            fontsize=13,
        )
...
for i in range(len(["Left", "Right"])):
    for j in range(len(["Left", "Right"])):
        plt.text(
            j,
            i,
            "{:.2%}".format(cm_2_percentage[i, j]),
            ha="center",
            va="center",
            color="white"
            if cm_2_percentage[i, j] > cm_2_percentage.max() / 2.0
            else "black",
            fontsize=13,
        )
